...
#if (SPI == 1 )
/*===================== SPI definition strucure==============*/
typedef struct{
   volatile uint32_t SPI_CR1;                                                                                 /*<It is SPI control register 1                         >*/
   volatile uint32_t SPI_CR2;                                                                                 /*<It is SPI control register 2                         >*/
   volatile uint32_t SPI_SR;                                                                                  /*<It is SPI status register                            >*/
   volatile uint32_t SPI_DR;                                                                                  /*<It is SPI data register                              >*/
   volatile uint32_t SPI_CRCPR;                                                                               /*<It is SPI CRC polynomial register                    >*/
   volatile uint32_t SPI_RXCRCR;                                                                              /*<It is SPI RX CRC register                            >*/
   volatile uint32_t SPI_TXCRCR;                                                                              /*<It is SPI TX CRC registe                             >*/
   volatile uint32_t SPI_I2SCFGR;                                                                             /*<It is SPI_I2S configuration register                 >*/
   volatile uint32_t SPI_I2SPR;                                                                               /*<It is SPI_I2S prescaler register                     >*/
}SPI_RegDef_t;
...
/*===================== Casting SPI definition ==============*/
#define SPI1                                               ((SPI_RegDef_t*)SPI1_BASEADDR)            /*<It is  casting for SPI1  struct                     >*/   
#define SPI2                                               ((SPI_RegDef_t*)SPI2_BASEADDR)            /*<It is  casting for SPI2  struct                     >*/
#define SPI3                                               ((SPI_RegDef_t*)SPI3_BASEADDR)            /*<It is  casting for SPI3  struct                     >*/
#define SPI4                                               ((SPI_RegDef_t*)SPI4_BASEADDR)            /*<It is  casting for SPI4  struct                     >*/
